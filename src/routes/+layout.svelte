...
const themeOptions = ['juleslight', 'julesdark'] as const;
const lightTheme = 'juleslight';
const darkTheme = 'julesdark';
...
onMount(() => {
    theme = localStorage.getItem('theme') as null | 'juleslight' | 'julesdark';
});
...
function setTheme(event: Event) {
    ...
    theme = target.value as null | 'juleslight' | 'julesdark';
}
...
<div class="drawer md:drawer-open">
    ...
    <div class="drawer-content">
        <nav class="navbar bg-base-100">
            ...
            <div class="navbar-end space-x-0">
                <a href="https://www.linkedin.com/in/julesbb/" class="btn btn-ghost text-lg" aria-label="LinkedIn" title="LinkedIn">
                ...
                <div class="dropdown dropdown-end">
                    <div tabindex="0" role="button" id="toggleTheme" class="btn btn-ghost" aria-label="Select Theme">
                        <label class="swap swap-rotate" for="toggleTheme" class:swap-active={effectiveTheme === "juleslight"}>
                            <div class="swap-on">
    ...
    <div class="drawer-side lg:w-80">
        ...
        <div class="bg-base-200 min-h-screen">            
            <ul class="menu">
                <li class="menu-title text-xl font-slabserif font-light text-base-content"><span><strong class="font-bold inline">Jules</strong> Blanchet</span></li>
                ...
                <!-- <ul class="menu menu-horizontal p-0">
                    <li><a href="https://www.linkedin.com/in/julesbb/" class="btn btn-ghost text-xl btn-sm" aria-label="LinkedIn" title="LinkedIn">
                            <span class="icon-[fa6-brands--linkedin]"></span>
                    </a></li>
