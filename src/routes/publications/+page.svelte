    ...
    [
        {
            ...
            authors: ['Jules B. Blanchet', 'Megan E Hillis', 'Yeongji Lee', 'Qijia Shao', 'Xia Zhou', 'David JM Kraemer', 'Devin Balkcom'],
        ...
        },
        {
            ...
            authors: ['J.B. Blanchet', 'Sixuan Han'],
            highlightAuthorIndex: 0,
        ...
        },
        {
            ...
            year: 2023,
            conference: 'Adjunct Proceedings of the 36th Annual ACM Symposium on User Interface Software and Technology',
            authors: ['J.B. Blanchet', 'Megan E Hillis', 'Yeongji Lee', 'Qijia Shao', 'Xia Zhou', 'David JM Kraemer', 'Devin Balkcom'],
            highlightAuthorIndex: 0,
        ...
        },
        {
            ...
            authors: ['Luyang Zhao', 'Yijia Wu', 'J.B. Blanchet', 'Maxine Perroni-Scharf', 'Xiaonan Huang', 'Joran Booth', 'Rebecca Kramer-Bottiglio', 'Devin Balkcom'],
        ...
        },
        {
            ...
            authors: ['Megan E Hillis', 'Brianna Aubrey', 'J.B. Blanchet', 'Qijia Shao', 'Xia Zhou', 'Devin Balkcom', 'David JM Kraemer'],
            highlightAuthorIndex: 2,
        ...
        },
        {
            ...
            authors: ['Qijia Shao', 'Amy Sniffen', 'J.B. Blanchet', 'Megan E Hillis', 'Xinyu Shi', 'Themistoklis K Haris', 'Jason Liu', 'Jason Lamberton', 'Melissa Malzkuhn', 'Lorna C Quandt', 'James Mahoney', 'David JM Kraemer', 'Xia Zhou', 'Devin Balkcom'],
            highlightAuthorIndex: 2,
            doi: '10.1145/3432211',
        }
    ] as Publication[]
    ...
    {#each publications as pub}
        ...
        <!-- <div class="card shadow-lg compact bg-base-200">
            <div class="card-body">
                ...
                <p class="card-text">
                    {#each pub.authors as author, i}
                        {author}{i == pub.highlightAuthorIndex ? '*' : ''}{i == pub.authors.length - 1 ? '' : ', '}
                    {/each}
                </p>
                {#if pub.links.length > 0}
                <div class="card-actions justify-end">
                    {#each pub.links as link}
                        <a href={link.href} class="btn btn-primary btn-sm">
                            {link.title}
                            {#if link.external}
